				...
				<tr>
					...
					<td class="actions">			
						<div class="btn-group">
							...
							?>
							<?php echo $this->Html->link('<i class="icon-pencil"></i>', array('action' => 'edit', $resource['ViewResource']['id'], $resource_group_type_id, $parent_entityid), array('escape' => FALSE, 'class' => 'btn')); ?>
							...
							<?php echo $this->Html->link('<i class="icon-eye-open"></i>', array('action' => 'view', $resource['ViewResource']['id'], $resource_group_type_id, $parent_entityid, $this->Paginator->counter('{:count}')), array('escape' => FALSE, 'class' => 'btn')) ?>
							<?php
