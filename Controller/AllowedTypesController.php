...
class AllowedTypesController extends ResourcesAppController {
	...
	public function admin_add() {
		if ($this->request->is('post')) {
			...
			if ($this->AllowedType->save($this->request->data)) {
				$this->Session->setFlash(__('The allowed type has been saved'), 'flash/success');
				$this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash(__('The allowed type could not be saved. Please, try again.'), 'flash/error');
			}
		}
	...
	public function admin_delete($id = null) {
		...
		if ($this->AllowedType->delete()) {
			$this->Session->setFlash(__('Allowed type deleted'), 'flash/success');
			$this->redirect(array('action' => 'index'));
		}
		$this->Session->setFlash(__('Allowed type was not deleted'), 'flash/error');
		$this->redirect(array('action' => 'index'));
	}
